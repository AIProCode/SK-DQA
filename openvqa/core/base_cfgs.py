...
class BaseCfgs(PATH):
    def __init__(self):
        ...
        # For SKDQA-paper to choose language_global_context style: 'max', 'avg', and 'att'
        self.Lang_Global = 'max'
        
        # For SKDQA-paper to choose wether fusion global information g, default = False
        #self.gF = 'False'
        self.REL = 'False'
