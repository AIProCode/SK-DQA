...
class BaseDataSet(Data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        frcn_feat_iter = self.load_img_feats(idx, iid)
...
class BaseAdapter(nn.Module):
    ...
    def forward(self, frcn_feat, patch_feat, cap_feat):
        feat_dict = feat_filter(self.__C.DATASET, frcn_feat, patch_feat, cap_feat)
